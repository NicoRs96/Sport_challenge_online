...
/**
 * Servlet implementation class DisiscrivitiRenterServlet
 */
@WebServlet("/HomePageRenter")
public class DisiscrivitiRenterServlet extends HttpServlet {
     ...
     */
    public DisiscrivitiRenterServlet() {
        super();
    }
