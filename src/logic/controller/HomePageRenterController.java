...
public class HomePageRenterController implements Initializable{
	...
	private void inserisci(ActionEvent event) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/logic/view/InserisciCampoRenter.fxml"));
	...
	private void gestisci(ActionEvent event) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/logic/view/GestisciCampiRenter.fxml"));
		Parent root = loader.load();
	...
	private void creaTorneo(ActionEvent event) throws IOException, SQLException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/logic/view/CreaTorneo.fxml"));
		Parent root = loader.load();
	...
	private void gestisciTorneo(ActionEvent event) throws IOException, SQLException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/logic/view/GestisciTorneiRenter.fxml"));
		Parent root = loader.load();
