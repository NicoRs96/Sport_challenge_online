...
import logic.bean.CercaTorneoBean;
import logic.exception.MeteoIncompleteException;
...
public class CercaTorneoController implements Initializable {
    ...
    public void conferma() throws SQLException, IOException, MeteoIncompleteException {
        ...
        if(torneo.getEtaMin() > Period.between(this.persona.getDataPersona(), LocalDate.now()).getYears()){
            ...
            alert.setContentText("Attenzione, et� minima torneo superiore alla tua.");
            alert.showAndWait();
            return;
        }
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/logic/view/PartecipantiTorneo.fxml"));
        Parent root = loader.load();
